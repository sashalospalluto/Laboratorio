...
int cuentaFotos(void* element)
{
    ...
    Registro* foto;
    foto = (Registro*)element;

    returnRet = foto->cantidad;
...
int ventasUno (void* element)
{
    ...
    cantidadFotos = foto->cantidad;
    precio = foto->precio;
    total = cantidadFotos * precio;
...
int cuentaPolaroid (void* element)
{
    ...
    if (strcmp(foto->tipoFoto, "POLAROID_11x9")==0)
    {
        returnRet=1;
    }
    if (strcmp(foto->tipoFoto, "POLAROID_10x10")==0)
    {
        returnRet=1;
    }
    return returnRet;
