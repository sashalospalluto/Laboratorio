...
int ll_sort(LinkedList* this, int (*pFunc)(void* ,void*), int order)
{
    ...
    if(this!=NULL)
    {
        for(i=0;i<ll_len(this)-1;i++)
        {
            ...
            {
                devuelve=pFunc(ll_get(this,i),ll_get(this,j));
                if(devuelve==1 && order==1) //i>j y de menor a mayor
                {
                    pElement = ll_get(this, i);
                    ll_set(this,i,ll_get(this, j));
                    ll_set(this,j,pElement);
                }
                devuelve=devuelve=pFunc(ll_get(this,i),ll_get(this,j));
                if(devuelve==1 && order==0)
                {
                    pElement = ll_get(this, i);
                    ll_set(this,i,ll_get(this, j));
                    ll_set(this,j,pElement);
...
int ll_filter(LinkedList* this, int (*pFunc)(void*))
{
    ...
    if(this!=NULL && listaNueva!=NULL)
    {
        for(i=0; i<ll_len(this);i++)
        {
            devuelve=pFunc(ll_get(this,i));
            if(devuelve==1)
            {
                ll_add(listaNueva,ll_get(this,i));
            }
        }
        returnAux=0;
    }
...
int ll_reduce(LinkedList* this, int (*pFunc)(void*))
{
    ...
    if(this!=NULL && listaNueva!=NULL)
    {
        ...
        ll_clear(this);
        for(i=0;i<ll_len(listaNueva);i++)
        {
            ll_add(this,ll_get(listaNueva,i));
        }
        returnAux=0;
    }
    return returnAux;
